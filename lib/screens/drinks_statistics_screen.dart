...
class DrinkStatisticsScreen extends StatefulWidget {
  const DrinkStatisticsScreen({super.key});
...
class _DrinkStatisticsScreenState extends State<DrinkStatisticsScreen> {
              ...
              if (snapshot.hasData) {
                ...
                snapshot.data!.forEach((element) {
                  ...
                  if (_searchTextController.text.isEmpty ||
                      drinkStatistics.drink.name.toLowerCase().contains(
  ...
  Widget buildDrinkCard({
    required DrinkStatistics drinkStatistics,
      ...
      children: [
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              Text(drinkStatistics.drink.name, style: TextStyle(fontSize: 20)),
              Text(
                "Datum: ${drinkStatistics.date == null ? "-" : DateFormat('dd.MM.yyyy').format(drinkStatistics.date!.toLocal())}",
                style: TextStyle(fontSize: 14),
              ),
              Text(
                "letzte Zählung: ${drinkStatistics.amountActual} Fl.",
                style: TextStyle(fontSize: 14),
              ),
              Text(
                "seitdem gebucht: ${drinkStatistics.amountPurchased} Fl.",
                style: TextStyle(fontSize: 14),
              ),
              Text(
                "seitdem gekauft: ${drinkStatistics.amountNew} Fl.",
                style: TextStyle(fontSize: 14),
              ),
              Text(
                "Bestand erwartet: ${drinkStatistics.amountActual - drinkStatistics.amountPurchased + drinkStatistics.amountNew} Fl.",
                style: TextStyle(fontSize: 14),
              ),
            ],
          ),
